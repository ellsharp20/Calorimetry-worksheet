...
%
%% Title Set up
\styleTitle{Calorimetry/Heat Capacity}
%%
%
%%
...
\begin{align*}
    &   c_{water}\ = \qty[per-mode=fraction]{4.184}{\joule\per\gram\per\degreeCelsius} = \qty[per-mode=fraction]{1}{\calorie \per\gram \per\degreeCelsius} & d_{water}\ = 1\ \cfrac{\si{\g}}{\si{\mL}} &
\end{align*}

\subsubsection{Unit Conversions}
\begin{align*}
    & \SI{1}{\Calorie} = \qty{1000}{\calorie} & \qty{1}{\calorie} = \qty{4.184}{\joule} && \si{\degreeCelsius}\ = (\Fahrenheit - 32)\  \cdot \ \cfrac{5}{9} & 
\end{align*}
